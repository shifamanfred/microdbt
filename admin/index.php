...
<div class="row mt">
  ...
  <div class="col-md-4 col-sm-4 mb">
    <div class="grey-panel pn donut-chart">
      ...
      var doughnutData = [{
        // partner percentage
        value: <?php echo intval($partner_count / $total_loan_users * 100); ?>,
        color: "#FF6B6B"
      },
      {
        value: <?php echo intval(100 - $partner_count / $total_loan_users * 100); ?>,
        color: "#fdfdfd"
      }
    ];
...
<div class="col-md-4 col-sm-4 mb">
  <div class="darkblue-panel pn">
    ...
    <script>
    var doughnutData = [{
      value: <?php echo intval($borrower_count / $total_loan_users * 100);?>,
      color: "#f68275"
    },
    {
      value: <?php echo intval(100 - $borrower_count / $total_loan_users * 100); ?>,
      color: "#1c9ca7"
    }
  ];
  ...
  <footer>
    <div class="pull-left">
      <h5 style="color: #1c9ca7"><?php echo $total_loan_users - $borrower_count; ?> Users</h5>
    </div>
    <div class="pull-right">
      <h5 style="color: #f68275"><?php echo $borrower_count; ?> Clients</h5>
    </div>
  </footer>
</div>
<!--  /darkblue panel -->
...
<div class="col-md-4 col-sm-4 mb">
  ...
  <div class="white-panel pn">
    ...
    <div class="row">
      <div class="col-md-6">
        <p class="small mt">Number of Transactions</p>
        <p>17</p> <!-- Amount to be pulled from the database -->
      </div>
      <div class="col-md-6">
        <p class="small mt">Total Amount</p>
        <p>$ 47,60</p> <!-- Amount to be pulled from the database -->
      </div>
    </div>
  </div>
</div>
