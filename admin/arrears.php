...
<section id="main-content">
  <section class="wrapper">
    <h3><i class="fa fa-angle-right"></i> Arrears</h3>
    <div class="row mt">
      <div class="col-md-12">
        <div class="content-panel">
          <table class="table table-striped table-advance table-hover">
            <h4><i class="fa fa-angle-right"></i> Bad Partners</h4>
            <hr>
            <thead>
              <tr>
                ...
                <th><i class="fa fa-bookmark"></i> Overdue Amount</th>
                <th><i class=" fa fa-edit"></i> Suspend</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
