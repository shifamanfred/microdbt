...
<aside>
  <div id="sidebar" class="nav-collapse ">
    ...
    <ul class="sidebar-menu" id="nav-accordion">
      ...
      <li class="sub-menu">
        <a class="<?php echo isset($page) && $page == 'partner' ? 'active' : '' ?>" href="view_partners.php">
          <span><i class="fa fa-chevron-left"></i> Partners</span>
        </a>
      </li>
    </ul>
    <!-- sidebar menu end-->
      ...
      <div class="col-lg-12">
        <div class="row content-panel">
          ...
          <div class="col-md-4 profile-text">
            <h3><?php echo $partner_obj->business_name; ?></h3>
            <h6>Main Administrator</h6>
            <p><strong>Currently Trading As:</strong> <?php echo $partner_obj->trade_name; ?></p>
            <p><strong>Registration Number:</strong> <?php echo $partner_obj->reg_num; ?></p>
            <br>
                  ...
                  <div class="col-md-8 detailed">
                    ...
                    <div class="row centered mt mb">
                      ...
                      <div class="col-sm-4">
                        ...
                        <h3>37</h3>
                        <h6>NUMBER OF LOANS DISBURED</h6>
                      </div>
                      <div class="col-sm-4">
                        <h1><i class="fa fa-shopping-cart"></i></h1>
                        <h3>$15 384</h3>
                        <h6>TOTAL LOAN AMOUNT DISBURSED</h6>
                      </div>
                    </div>
                    <!-- /row -->
                    <h4>My Friends</h4>
